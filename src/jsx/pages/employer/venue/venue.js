...
import {
   ...
   Icon11,
   Icon12,
} from "../../../CommonComponents/bootstrap/CompaniesIcons";
import {
   Col,
   Card,
   Table,
      ...
      <Fragment>
         ...
         <div className="row">
            <div className="col-xl-9 col-xxl-8">
               ...
               <Card>
                  <Card.Header>
                     <Card.Title>Venues List</Card.Title>
                  </Card.Header>
                  <Card.Body>
                     <Table responsive="sm" hover>
                        ...
                        <tbody>
                           <tr>
                              <th>1</th>
                              <td>Northwest High St</td>
                              <td>
                                 123 Balam way, Culchester
                              </td>
                              <td>H56 2AQ</td>
                              <td>
                              ...
                              <div className="d-flex flex-wrap col-xl-12">
                                 <div className="media mr-auto pr-2 mb-4">
                                    ...
                                    <div className="media-body text-left">
                                       ...
                                       <span className="fs-14">Workers</span>
                                    </div>
                                 </div>
                                 <div className="media mr-auto pr-2 mb-4">
                                    <svg
                                    ...
                                    <div className="media-body text-left">
                                       ...
                                       <span className="fs-14">Company Contact</span>
                                    </div>
                                 </div>
