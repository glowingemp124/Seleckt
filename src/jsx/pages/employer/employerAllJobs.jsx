...
const EmployerAllJobs = () => {
    ...
    const employersAllJobs = [
        {
            "ID": 1,
            "Company": "Tech Solutions Inc.",
            "Industry": "Technology",
            "Address": "UK",
            "Start Date & Time": "2024-08-01T09:00:00",
            "End Date & Time": "2024-08-01T17:00:00",
            "Hours": 8,
            "Action": "View"
        },
        {
            ...
            "Industry": "Healthcare",
            "Address": "Canada",
            "Start Date & Time": "2024-08-02T08:00:00",
            "End Date & Time": "2024-08-02T16:00:00",
            "Hours": 8,
            "Action": "View"
        },
        {
            ...
            "Industry": "Finance",
            "Address": "UK",
            "Start Date & Time": "2024-08-03T10:00:00",
            "End Date & Time": "2024-08-03T18:00:00",
            "Hours": 8,
            "Action": "View"
        },
        {
            ...
            "Industry": "Retail",
            "Address": "Canada",
            "Start Date & Time": "2024-08-04T11:00:00",
            "End Date & Time": "2024-08-04T19:00:00",
            "Hours": 8,
            "Action": "View"
        },
        {
            ...
            "Industry": "Education",
            "Address": "UK",
            "Start Date & Time": "2024-08-05T09:30:00",
            "End Date & Time": "2024-08-05T15:30:00",
            "Hours": 6,
            "Action": "View"
        },
        {
            ...
            "Address": "Canada",
            "Start Date & Time": "2024-08-06T07:00:00",
            "End Date & Time": "2024-08-06T15:00:00",
            "Hours": 8,
            "Action": "View"
        },
        {
            ...
            "Address": "UK",
            "Start Date & Time": "2024-08-07T12:00:00",
            "End Date & Time": "2024-08-07T20:00:00",
            "Hours": 8,
            "Action": "View"
        }
    ]
    ...
    const getEmployers = () => {
        return employersAllJobs.map((job) => {
            return (
                <tr key={job.ID} role="row" className="odd">
                    ...
                    <td>
                        <div className="">
                            <div className="text-nowrap ">
                                <h6 className="mb-0 text-center">{job.Address}</h6>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div className="">
                            <div className="-body text-nowrap">
                                <h6 className="mb-0">{new Date(job["Start Date & Time"]).toLocaleString()}</h6>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div className="">
                            <div className="-body text-nowrap">
                                <h6 className="mb-0">{new Date(job["End Date & Time"]).toLocaleString()}</h6>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div className="">
                            <h6 className="mb-0 text-center">{job.Hours} hrs</h6>
                        </div>
                    </td>
            ...
            <div className='row justify-content-between'>
                {
                    industries?.data?.body?.industries.filter(item => item.is_user_industry).map((indust, idx) => (
                        <Button
                            key={idx}
                            variant={activeIndustryButton === idx ? 'primary' : 'outline-primary'}
                            className="col-5 rounded-4 py-5"
    ...
    const skillsContent = (
        <Stack>
            <div className='row justify-content-between'>
                ...
                )) : <p>Please first, select the job role</p>}
            </div>
    ...
    const jobRoles = (
        <Stack>
            <div>
                <p>You can choose more than one job role</p>
            </div>
                            ...
                            <div className="h-80">
                                ...
                                <div className="d-flex flex-wrap mb-4 row">
                                    ...
                                    <div className="col-lg-6 col-sm-12 mb-2 ">
                                        <Form className="d-flex gap-2 justify-content-end mt-4">
                                            ...
                                            <Dropdown onSelect={handleSelectOffers} className=" flex-grow-1" style={{ maxWidth: '200px' }}>
                                                <Dropdown.Toggle id="dropdown-offers" className=" rounded-4 border-dark w-100 custom-dropdown-toggle bg-transparent text-success ">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    {!isLoading ? (
                                                        <tbody>
                                                            {
                                                                employersAllJobs?.length > 0 ? getEmployers() : (
                                                                    <tr>
