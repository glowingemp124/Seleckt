                  ...
                  <InputGroup className="">
                     <InputGroup.Text className="bg-transparent">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M1.5 8.5H22.5M17.8333 13.1683L6.16667 13.1667M10.0556 17.8339L6.16667 17.8333M6.16667 1.5V3.83333M17.8333 1.5V3.83333M5.23333 22.5H18.7667C20.0735 22.5 20.7269 22.5 21.226 22.2457C21.665 22.022 22.022 21.665 22.2457 21.226C22.5 20.7269 22.5 20.0735 22.5 18.7667V7.56667C22.5 6.25988 22.5 5.60648 22.2457 5.10736C22.022 4.66831 21.665 4.31136 21.226 4.08765C20.7269 3.83333 20.0735 3.83333 18.7667 3.83333L5.23333 3.83333C3.92654 3.83333 3.27315 3.83333 2.77402 4.08765C2.33498 4.31136 1.97802 4.66831 1.75432 5.10736C1.5 5.60648 1.5 6.25988 1.5 7.56667L1.5 18.7667C1.5 20.0735 1.5 20.7269 1.75432 21.226C1.97802 21.665 2.33498 22.022 2.77402 22.2457C3.27315 22.5 3.92654 22.5 5.23333 22.5Z" stroke="#00B094" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                     </InputGroup.Text>
                     <FormControl
                        className="rounded-3 border-0"
                  ...
                  <InputGroup className="">
                     <InputGroup.Text className="bg-transparent">
                        <svg width="20" height="24" viewBox="0 0 20 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M10.0026 22.5C14.0859 18.3 18.1693 14.5392 18.1693 9.9C18.1693 5.26081 14.5129 1.5 10.0026 1.5C5.49228 1.5 1.83594 5.26081 1.83594 9.9C1.83594 14.5392 5.91927 18.3 10.0026 22.5Z" stroke="#00B094" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                           <path d="M10.0026 13.1667C11.9356 13.1667 13.5026 11.5997 13.5026 9.66667C13.5026 7.73367 11.9356 6.16667 10.0026 6.16667C8.06961 6.16667 6.5026 7.73367 6.5026 9.66667C6.5026 11.5997 8.06961 13.1667 10.0026 13.1667Z" stroke="#00B094" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                     </InputGroup.Text>
                     <FormControl
                        className="rounded-3 border-0"
            ...
            <Modal.Body>
               ...
               <div className="rounded-3 my-4" style={{ border: '1px solid #e5e5e5' }}>
                  <InputGroup className="">
                     <InputGroup.Text className="bg-transparent">
                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M15.1667 23.3337V21.0003C15.1667 17.7787 12.555 15.167 9.33333 15.167C6.11167 15.167 3.5 17.7787 3.5 21.0003V23.3337H15.1667ZM15.1667 23.3337H24.5V22.167C24.5 18.7306 21.8883 16.3337 18.6667 16.3337C17.0178 16.3337 15.5287 17.0634 14.4678 18.2366M12.8333 8.16699C12.8333 10.1 11.2663 11.667 9.33333 11.667C7.40034 11.667 5.83333 10.1 5.83333 8.16699C5.83333 6.234 7.40034 4.66699 9.33333 4.66699C11.2663 4.66699 12.8333 6.234 12.8333 8.16699ZM21 10.5003C21 11.789 19.9553 12.8337 18.6667 12.8337C17.378 12.8337 16.3333 11.789 16.3333 10.5003C16.3333 9.21166 17.378 8.16699 18.6667 8.16699C19.9553 8.16699 21 9.21166 21 10.5003Z" stroke="#00B094" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                     </InputGroup.Text>
                     <FormControl
                        className="rounded-3 border-0"
