                     ...
                     <div className="media align-items-center">
                        ...
                        >
                           <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <path d="M32.5 50V45C32.5 38.0964 26.9036 32.5 20 32.5C13.0964 32.5 7.5 38.0964 7.5 45V50H32.5ZM32.5 50H52.5V47.5C52.5 40.1362 46.9036 35 40 35C36.4667 35 33.2758 36.5637 31.0023 39.0778M27.5 17.5C27.5 21.6421 24.1421 25 20 25C15.8579 25 12.5 21.6421 12.5 17.5C12.5 13.3579 15.8579 10 20 10C24.1421 10 27.5 13.3579 27.5 17.5ZM45 22.5C45 25.2614 42.7614 27.5 40 27.5C37.2386 27.5 35 25.2614 35 22.5C35 19.7386 37.2386 17.5 40 17.5C42.7614 17.5 45 19.7386 45 22.5Z" stroke="#00B094" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                           </svg>
                     ...
                     <div className="media align-items-center">
                        ...
                        >
                           <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <path d="M40 17.5C40 23.0228 35.5228 27.5 30 27.5C24.4772 27.5 20 23.0228 20 17.5C20 11.9772 24.4772 7.5 30 7.5C35.5228 7.5 40 11.9772 40 17.5Z" stroke="#00B094" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                              <path d="M30 35C20.335 35 12.5 42.835 12.5 52.5H47.5C47.5 42.835 39.665 35 30 35Z" stroke="#00B094" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                           </svg>
